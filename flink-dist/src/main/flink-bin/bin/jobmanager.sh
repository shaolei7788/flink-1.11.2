...
if [[ $STARTSTOP == "start-foreground" ]]; then
    ...
    # TMS 马中华 注释： 通过 flink-daemon.sh 脚本来启动 TaskManager（StandaloneSessionClusterEndpoint）
    # TMS 马中华 注释： flink-daemon.sh start standalonesession
