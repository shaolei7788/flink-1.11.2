...
public final class JobSubmitRequestBody implements RequestBody {
	...
	@JsonCreator
	public JobSubmitRequestBody(@Nullable @JsonProperty(FIELD_NAME_JOB_GRAPH) String jobGraphFileName,
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(jobGraphFileName, that.jobGraphFileName) && Objects.equals(jarFileNames, that.jarFileNames) && Objects
			.equals(artifactFileNames, that.artifactFileNames);
	}
	...
	public String toString() {
		return "JobSubmitRequestBody{" + "jobGraphFileName='" + jobGraphFileName + '\'' + ", jarFileNames=" + jarFileNames + ", artifactFileNames=" + artifactFileNames + '}';
	}
	...
	public static class DistributedCacheFile {
		...
		@JsonCreator
		public DistributedCacheFile(@JsonProperty(FIELD_NAME_ENTRY_NAME) String entryName, @JsonProperty(FIELD_NAME_FILE_NAME) String fileName) {
		...
		public boolean equals(Object o) {
			...
			return Objects.equals(entryName, that.entryName) && Objects.equals(fileName, that.fileName);
		}
		...
		@Override
		public String toString() {
			return "DistributedCacheFile{" + "entryName='" + entryName + '\'' + ", fileName='" + fileName + '\'' + '}';
		}
	}
}
